...
const competitions: Competition[] = [
  ...
  },
  {
    ...
    prize: "🎁 Participation Gift: For valid entries with 500+ views\n🏅 Top 3 Reels: Premium LPU Merchandise",
  ...
  },
  {
    ...
    description: "Take a selfie at LPU’s official Selfie Point, post it on Instagram using the designated hashtag(#lpu #lpuuniversity), and tag the official LPU page.",
    prize: "🎁 Participation Gift: For posts with 50+ likes",
